#include "../src/NumbersWithFileLoggerCamera.h"
...
TEST(TestNumbersWithFileLoggerCamera, testCameraStatus)
{
    auto numbersWithFileLoggerCamera = VCA::NumbersWithFileLogger::NumbersWithFileLoggerCamera("");
    EXPECT_EQ(numbersWithFileLoggerCamera.getStatus().status(), VCA::SDK::v1::CameraStatus::Status::OFFLINE);
    numbersWithFileLoggerCamera.connect();
    EXPECT_EQ(numbersWithFileLoggerCamera.getStatus().status(), VCA::SDK::v1::CameraStatus::Status::ONLINE);
    numbersWithFileLoggerCamera.disconnect();
    EXPECT_EQ(numbersWithFileLoggerCamera.getStatus().status(), VCA::SDK::v1::CameraStatus::Status::OFFLINE);
}

TEST(TestNumbersWithFileLoggerCamera, testAcquireRedImage)
{
    auto numbersWithFileLoggerCamera = VCA::NumbersWithFileLogger::NumbersWithFileLoggerCamera("red");
    numbersWithFileLoggerCamera.connect();

    auto image1 = numbersWithFileLoggerCamera.acquireImage();
    ...
    auto image2 = numbersWithFileLoggerCamera.acquireImage();
...
TEST(TestNumbersWithFileLoggerCamera, testAcquireGreenImage)
{
    auto numbersWithFileLoggerCamera = VCA::NumbersWithFileLogger::NumbersWithFileLoggerCamera("green");
    numbersWithFileLoggerCamera.connect();
...
TEST(TestNumbersWithFileLoggerCamera, testAcquireBlueImage)
{
    auto numbersWithFileLoggerCamera = VCA::NumbersWithFileLogger::NumbersWithFileLoggerCamera("blue");
    numbersWithFileLoggerCamera.connect();
...
TEST(TestNumbersWithFileLoggerCamera, testAcquireBlackImage)
{
    auto numbersWithFileLoggerCamera = VCA::NumbersWithFileLogger::NumbersWithFileLoggerCamera("");
    numbersWithFileLoggerCamera.connect();
...
TEST(TestNumbersWithFileLoggerCamera, testAcquireModifiedImage)
{
    auto numbersWithFileLoggerCamera = VCA::NumbersWithFileLogger::NumbersWithFileLoggerCamera("");
    numbersWithFileLoggerCamera.connect();
    ...
    const auto setConfigResult = numbersWithFileLoggerCamera.setConfig(
    ...
    const auto getConfigResult = numbersWithFileLoggerCamera.getConfig();
...
TEST(TestNumbersWithFileLoggerCamera, testAcquireImageWithIncreasedFPS)
{
    auto numbersWithFileLoggerCamera = VCA::NumbersWithFileLogger::NumbersWithFileLoggerCamera("");
    numbersWithFileLoggerCamera.connect();
    ...
    const auto setConfigResult = numbersWithFileLoggerCamera.setConfig(VCA::SDK::v1::CameraParameters{fpsParameter});
    ...
    for (int i = 0; i < 10; ++i)
    {
        numbersWithFileLoggerCamera.acquireImage();
    }
