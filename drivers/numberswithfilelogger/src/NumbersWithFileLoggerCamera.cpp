...
{
    NumbersWithFileLoggerCamera::NumbersWithFileLoggerCamera(const std::string& cameraType) : Camera(cameraType)
    {
        if (cameraType == "red")
        {
        ...
        LOG_NUMBERSWITHFILELOGGER_PLUGIN_INFO("Camera created with unique id '" + cameraType + "'");
    }
    ...
    void NumbersWithFileLoggerCamera::startImageAcquisition()
    {
        LOG_NUMBERSWITHFILELOGGER_PLUGIN_INFO("Image acquisition started for camera with unique id '" +
                                              cameraUniqueId() + "'");
    }

    void NumbersWithFileLoggerCamera::stopImageAcquisition()
    {
        LOG_NUMBERSWITHFILELOGGER_PLUGIN_INFO("Image acquisition stopped for camera with unique id '" +
                                              cameraUniqueId() + "'");
    }
    ...
    SDK::v1::CameraParameterStatuses
    NumbersWithFileLoggerCamera::setConfig(const SDK::v1::CameraParameters& parametersToChange)
    {
    ...
    SDK::v1::CameraStatus NumbersWithFileLoggerCamera::getStatus() const
    {
        const auto status =
