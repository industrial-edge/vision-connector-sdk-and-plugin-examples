...
\brief      Initialize the device library for some resource application operations. This interface must be called
            ...
            the library when the GxIAPI is stopped for all control of the device.
...
//----------------------------------------------------------------------------------
/**
\brief      Close the device library to release library. You must to call this interface to release library
